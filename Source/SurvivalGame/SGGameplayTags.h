...
namespace SGGameplayTags
{
	...
	SURVIVALGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Ability_Interact_Primary);
	SURVIVALGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Ability_Interact_Secondary);
	...
	SURVIVALGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Interaction_WaitForInput);
	SURVIVALGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Interaction_Blocked);
